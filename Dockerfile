...
ARG REPOSITORY_TRUFFLEHOG_VERSION=3.93.3
...
RUN python -m pip install --no-cache-dir "wheel>=0.46.2" "setuptools=81.0.0" \
...
ARG KUBERNETES_KUBESCAPE_VERSION=4.0.1
...
ARG PHP_FRIENDSOFPHP_PHP_CS_FIXER_VERSION=v3.94.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.55.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.55.0
...
RUN uv pip install --system --no-cache pip==${PIP_PIP_VERSION} virtualenv==${PIP_VIRTUALENV_VERSION} \
    ...
    && VIRTUAL_ENV="/venvs/ansible-lint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/cpplint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/cfn-lint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/stylelint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/djlint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/rumdl" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/pylint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/black" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/flake8" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/isort" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/bandit" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/mypy" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/ruff" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/ruff-format" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/checkov" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/semgrep" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/robocop" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/rst-lint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/rstcheck" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/rstfmt" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/snakemake" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/snakefmt" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/proselint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/codespell" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/sqlfluff" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
    ...
    && VIRTUAL_ENV="/venvs/yamllint" uv pip install --no-cache --upgrade "wheel>=0.46.2" "setuptools=81.0.0" \
...
RUN npm --no-cache install --ignore-scripts --omit=dev \
                ...
                @stoplight/spectral-owasp-ruleset@^2.0 \
